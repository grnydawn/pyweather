...
test: ## run tests quickly with the default Python: --tb=short
	pytest ./tests -s -vv --pyargs pyweather
	#pytest ./tests -s -v --pyargs pyweather --tb=short

testone: ## run tests quickly with the default Python: --tb=short
	pytest ./tests/${FILE} -s -vv --pyargs pyweather
...
coverage: ## check code coverage quickly with the default Python
	...
	coverage run --source ${NAME} pytest --pyargs pyweather
	coverage report -m
	#coverage html
