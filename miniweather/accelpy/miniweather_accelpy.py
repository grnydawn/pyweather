...
spec_state = os.path.join(here, "state.knl")
...
class LocalDomain():
    ...
    def __init__(self, nx_glob, nz_glob, data_spec, outfile, workdir,
        ...
        with open(spec_state) as fp:
            self.kernel_state= accelpy.Kernel(fp.read())
    ...
    def compute_tendencies_z(self, state):
        ...
        self.accel.launch(self.kernel_z, *data,
            updateto=(state, ), updatefrom=(self.tend,), environ=env)
...
#        print("state_init sum: %f" % state_init.sum())
        ...
        self.accel.launch(self.kernel_state, *data,
